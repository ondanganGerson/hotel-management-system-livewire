                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{ asset('image/user1-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{ asset('image/user7-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{asset('image/user3-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{ asset('image/user5-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{asset('image/user6-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{asset('image/user8-128x128.jpg')}}" alt="User Avatar">
